...
export const helpScreen = (onBack: () => void): HTMLElement =>
  el('div', { class: 'screen' }, [
    ...
    el('div', { class: 'help' }, [
      ...
      helpItem('📮', 'Directional cups', 'A cup with a wedge drawn on it only takes the ball arriving on that heading — and it will not funnel you in from any other side.'),
